...
f = open("hospital.txt",mode='at', encoding='utf-8') # you can change file name in here!
                ...
                try:
                    ...
                    for link in get_blog_post_content_soup.select('#mainFrame'):
                        ...
                        for blog_post_content in get_real_blog_post_content_soup.select('div#postViewArea'):
                            ...
                            f.writelines("포스팅 제목 : " + blog_post_title +"|")
                            f.writelines("포스팅 내용 : " + blog_post_full_contents +"|")
                except:
                    j += 1
...
if __name__ == '__main__':
    naver_blog_crawling("강원도 양양", 100, "sim") #You can change your keyword and to process the number of postss
    f.close()
